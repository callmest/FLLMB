...
2->5->4->3->1。需要注意的是，参考资料4非常值得阅读，系统讨论了数学公式。参考资料1可能需要一些基础之后才能看懂。其次，生成模型VAE和GAN也是需要去了解的：AE-VAE-GAN，尤其是关于最大似然估计到推导变分下界的数学变换，还是很有启发。

--------

Edited By Tao Shen 2024-10-22
...
- DDIM Sampling code in notebook (2024-11-10)
